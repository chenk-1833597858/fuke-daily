...
class AppPrefs @Inject constructor(
    ...
    private object Keys {
        ...
        val AUTO_TRIGGER_DATE = stringPreferencesKey("auto_trigger_date")
    ...
    val mainlineConfig: Flow<MainlineConfig> = dataStore.data
        ...
        .map { prefs ->
            MainlineConfig(
                ...
                autoTriggerDate = prefs[Keys.AUTO_TRIGGER_DATE] ?: "",
            )
        }
    ...
    suspend fun setMainlineConfig(config: MainlineConfig) {
        dataStore.edit { prefs ->
            ...
            prefs[Keys.AUTO_TRIGGER_DATE] = config.autoTriggerDate
        }
    }
